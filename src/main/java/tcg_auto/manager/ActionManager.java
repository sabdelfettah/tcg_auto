...
public abstract class ActionManager {
	...
	public static void updateCourseList() {
		LogManager.logInfo(Messages.getString(Lang.LOG_MESSAGE_INFO_UPDATING_COURSE_LIST));
		...
		LogManager.logInfo(String.format(Messages.getString(Lang.LOG_MESSAGE_INFO_UPDATING_COURSE_LIST), numberOfCourses));
	}
